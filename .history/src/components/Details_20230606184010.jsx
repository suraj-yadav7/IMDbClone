...
const Details = () => {
  ...
  const fetchMovieById= async()=>[   
    await fetch("https://api.themoviedb.org/3/movie/385687?api_key=9c6d31f462d1f29aa5dd899cd00c34b5").then((response)=>response.json()).then((data)=> setMovieDetails(data))
  ]
  useEffect(()=>{
    fetchGenre()
    fetchMovieById()
