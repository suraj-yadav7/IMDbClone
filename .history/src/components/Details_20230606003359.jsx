...
const Details = () => {
  ...
  console.log("The genre data", genreData.genres[1].id)
  ...
  console.log("the sgenre movie",singleMovieData.genre_ids[1])
    return (
        <div className="movie">
                        ...
                        <div className="movie__genres">
                            {
                                ...
                                genreData.genres.map(genre => {
                                  if(genre.id === singleMovieData.genre_ids.forEach((element) => element[0]) ;
                                )}
