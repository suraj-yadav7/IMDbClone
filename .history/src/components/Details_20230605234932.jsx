...
const Details = () => {
  ...
  const fetchGenre = async() =>{
    await fetch(`https://api.themoviedb.org/3/genre/movie/list?api_key=${MyApi}&language=en-US`).then((response)=>response.json()).then((data)=>setGenreData(data)).error((error)=>console.log(error))
